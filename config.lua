...
Config.AuthorizedVehicles = {
	Shared = {
		{ model = 'crusader', label = 'Jeep Militar', price = 1 },
		{ model = 'besra', label = 'Avion Caza Besra', price = 1 },
		{ model = 'valkyrie', label = 'Helicoptero Valkyrie', price = 1 },
		{ model = 'buzzard2', label = 'Helicoptero Linterna', price = 1 },
		{ model = 'barracks', label = 'Camion Barracas', price = 1 },	
		{ model = 'rhino', label = 'Tanque', price = 1 },
		{ model = 'apc', label = 'Tanqueta APC', price = 1 },
		{ model = 'kuruma2', label = 'Coche blindado', price = 1 },
		{ model = 'cargobob', label = 'Helicoptero Cargo', price = 1 },
		{ model = 'titan', label = 'Titán', price = 1 },
		{ model = 'lazer', label = 'Avion Caza', price = 1 },
		{ model = 'hydra', label = 'Avion hydra', price = 1 },
